...
class ExtendedKalmanFilterSLAM:
    ...
    def predict(self, control):
        ...
        self.state = append(self.g(self.state, control, self.robot_width), old_state[3:], axis = -1)  # Replace this.
...
if __name__ == '__main__':
    ...
    initial_state = array([500.0, 0.0, 45.0 / 180.0 * pi]) # We could have taken 0,0,0 also

    # Covariance at start position.
    initial_covariance = zeros((3,3)) # i.e. the initial pose has no error
